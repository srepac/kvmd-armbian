...
Original Script [http://192.236.131.217/RPiKVM/install-pikvm-raspbian.sh]
...
```
wget --no-check-certificate -O /usr/local/bin/update-rpikvm.sh http://192.236.131.217/RPiKVM/update-rpikvm.sh
update-rpikvm.sh
```
